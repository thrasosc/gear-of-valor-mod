...
import net.pixeldreamstudios.gearofvalor.item.armor.client.renderer.NightRiderArmorRenderer;
...
public class NightRiderArmorItem extends ValorArmorItem implements GeoItem {
    private final AnimatableInstanceCache cache = AzureLibUtil.createInstanceCache(this);
    private final Supplier<Object> renderProvider = GeoItem.makeRenderer(this);

    public NightRiderArmorItem(Type type, Properties properties) {
        super(ValorArmorMaterials.NIGHT_RIDER, type, properties);
    }
