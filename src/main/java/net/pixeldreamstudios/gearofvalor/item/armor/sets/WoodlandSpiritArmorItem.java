...
public class WoodlandSpiritArmorItem extends ValorArmorItem implements GeoItem {
    ...
    public WoodlandSpiritArmorItem(Type type, Properties properties) {
        super(ValorArmorMaterials.WOODLAND_SPIRIT, type, properties);
    }

    @Override
    public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> list, TooltipFlag tooltipFlag) {
        list.add(Component.translatable("Embrace the whispers of the forest").withStyle(ChatFormatting.DARK_GRAY));
