package net.pixeldreamstudios.gearofvalor.item.armor.client.model.abstraction;
...
public abstract class CapeArmorModel<T extends ValorArmorItem & GeoAnimatable> extends GeoModel<T> {
    @Override
